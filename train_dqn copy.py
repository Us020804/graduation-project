...
with open("dqn_peak_canteen_rewards.json", "w", encoding="utf-8") as f:
...
print("奖励结果已保存到 dqn_peak_canteen_rewards.json")
print("评估结果已保存到 dqn_peak_canteen_eval_rewards.json")
